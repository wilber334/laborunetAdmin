...
function CardAnunciosDelUsuario({ item }) {
    ...
    return (
        <div className="p-1 my-1 h-min shadow-md shadow-yellow-700 border border-blue-900 rounded-md cursor-pointer">
            <p className="font-semibold italic">ID de Usuario: {item.id}</p>
...
export default CardAnunciosDelUsuario;